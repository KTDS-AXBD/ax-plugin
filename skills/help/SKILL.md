...
name: help
description: |
  ax 스킬셋 사용 가이드 — 16개 명령 + 1개 스킬의 용도, 서브커맨드, 실전 사례 안내.
  Use when: ax help, ax 도움말, 명령 목록, 사용법, ax commands, 뭐가 있어
argument-hint: "[명령명] — 특정 명령 상세 보기 (생략 시 전체 목록)"
user-invocable: true
allowed-tools:
  - Read
  - Glob
